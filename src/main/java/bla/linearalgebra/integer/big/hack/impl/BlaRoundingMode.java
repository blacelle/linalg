 ...
 * {@code BlaBigDecimal} number with the specified value, forming a
 ...
 * calling {@link BlaBigDecimal#round round} on this number with the
 ...
 * enumeration of rounding mode constants in {@link BlaBigDecimal}
 * ({@link BlaBigDecimal#ROUND_UP}, {@link BlaBigDecimal#ROUND_DOWN},
 * etc. ).
 *
 * @see     BlaBigDecimal
 * @see     MathContext
...
public enum BlaRoundingMode {
    ...
    DOWN(BlaBigDecimal.ROUND_DOWN),
         ...
         *</table>
         */
    CEILING(BlaBigDecimal.ROUND_CEILING),
         ...
         *</table>
         */
    FLOOR(BlaBigDecimal.ROUND_FLOOR),
         ...
         *</table>
         */
    HALF_UP(BlaBigDecimal.ROUND_HALF_UP),
         ...
         *</table>
         */
    HALF_DOWN(BlaBigDecimal.ROUND_HALF_DOWN),
         ...
         *</table>
         */
    HALF_EVEN(BlaBigDecimal.ROUND_HALF_EVEN),
         ...
         *</table>
         */
    UNNECESSARY(BlaBigDecimal.ROUND_UNNECESSARY);

    // Corresponding BlaBigDecimal rounding constant
    final int oldMode;

    /**
     * Constructor
     *
     * @param oldMode The {@code BlaBigDecimal} constant corresponding to
     *        this mode
     */
    private BlaRoundingMode(int oldMode) {
        this.oldMode = oldMode;
    }

    /**
     * Returns the {@code RoundingMode} object corresponding to a
     * legacy integer rounding mode constant in {@link BlaBigDecimal}.
     *
     * @param  rm legacy integer rounding mode to convert
     * @return {@code RoundingMode} corresponding to the given integer.
     * @throws IllegalArgumentException integer is out of range
     */
    public static BlaRoundingMode valueOf(int rm) {
        switch(rm) {

        case BlaBigDecimal.ROUND_UP:
            return UP;

        case BlaBigDecimal.ROUND_DOWN:
            return DOWN;

        case BlaBigDecimal.ROUND_CEILING:
            return CEILING;

        case BlaBigDecimal.ROUND_FLOOR:
            return FLOOR;

        case BlaBigDecimal.ROUND_HALF_UP:
            return HALF_UP;

        case BlaBigDecimal.ROUND_HALF_DOWN:
            return HALF_DOWN;

        case BlaBigDecimal.ROUND_HALF_EVEN:
            return HALF_EVEN;

        case BlaBigDecimal.ROUND_UNNECESSARY:
            return UNNECESSARY;
