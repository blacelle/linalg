...
class BitSieve {
     ...
     * constructor, BitSieve(BlaBigInteger base, int searchLen).  The length
     ...
     * be even.
     */
    BitSieve(BlaBigInteger base, int searchLen) {
        /*
        ...
        MutableBlaBigInteger b = new MutableBlaBigInteger(base);
     ...
     */
    BlaBigInteger retrieve(BlaBigInteger initValue, int certainty, java.util.Random random) {
        ...
        for (int i=0; i<bits.length; i++) {
            ...
            for (int j=0; j<64; j++) {
                if ((nextLong & 1) == 1) {
                    BlaBigInteger candidate = initValue.add(
                                           BlaBigInteger.valueOf(offset));
